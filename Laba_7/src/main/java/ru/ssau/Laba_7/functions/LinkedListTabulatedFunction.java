...
import ru.ssau.Laba_7.exceptions.ArrayIsNotSortedException;
import ru.ssau.Laba_7.exceptions.DifferentLengthOfArraysException;
import ru.ssau.Laba_7.exceptions.InterpolationException;
...
//    }
    ...
    @Override
    public Iterator<ru.ssau.Laba_7.functions.Point> iterator() throws UnsupportedOperationException{
        return new Iterator<ru.ssau.Laba_7.functions.Point>() {
            ...
            @Override
            public ru.ssau.Laba_7.functions.Point next(){

                if(hasNext()){
                    ru.ssau.Laba_7.functions.Point point = new Point();
